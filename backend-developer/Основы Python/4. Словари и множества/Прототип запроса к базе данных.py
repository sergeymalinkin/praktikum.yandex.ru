...
# Добавьте новое условие в конструкцию if функции process_query(). В случае, если запрос содержит значение 'Где все
# мои друзья?', нужно вернуть сообщение 'Твои друзья в городах: ' и перечислить все уникальные города,
# в которых находятся друзья пользователя.
...
def process_query(query):
    if query == 'Сколько у меня друзей?':
        ...
        return 'Твои друзья в городах: ' + ', '.join(base.difference())
    else:
