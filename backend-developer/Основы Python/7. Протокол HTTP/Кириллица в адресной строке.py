# v Вы получили страшный URL. Расшифруйте, какой вопрос задал Яндексу пользователь. В ответ напечатайте запрос в
# чистом виде, без специальных символов. Например, он может выглядеть так: что такое помидор.
